# docker build -t my-neovim-dev:v0.0.1 -f my-neovim-dev.dockerfile .
...
# Install OpenJDK 22
RUN wget --no-check-certificate https://d6.injdk.cn/openjdk/openjdk/22/${JAVA_VERSION}_linux-aarch64_bin.tar.gz && \
